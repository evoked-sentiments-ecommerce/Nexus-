...
exports.paymentReceiptSubject = paymentReceiptSubject;
exports.paymentReceiptHtml = paymentReceiptHtml;
exports.paymentReceiptText = paymentReceiptText;
function paymentReceiptSubject(data) {
...
function paymentReceiptHtml(data) {
    const { customerName, invoiceId, planName, amount, currency, paidAt, billingPeriodStart, billingPeriodEnd, receiptUrl, } = data;
    const billingPeriodRow = billingPeriodStart && billingPeriodEnd
        ? `<tr>
...
function paymentReceiptText(data) {
