...
exports.resolveMonitoringConfig = resolveMonitoringConfig;
...
exports.bootstrapMonitoring = bootstrapMonitoring;
...
function resolveSentryConfig() {
    ...
    if (!dsn) {
        (0, logger_1.logWarn)("Sentry DSN not configured — error tracking disabled");
        return null;
    }
    return {
        dsn,
...
function resolvePostHogConfig() {
    ...
    if (!apiKey) {
        (0, logger_1.logWarn)("PostHog API key not configured — analytics disabled");
        return null;
    }
    return {
        apiKey,
...
function initSentry(config) {
    ...
    (0, logger_1.logInfo)("Sentry initialised", {
...
function initPostHog(config) {
    ...
    (0, logger_1.logInfo)("PostHog initialised", { host: config.host });
    void config;
}
/**
